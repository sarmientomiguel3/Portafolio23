...
export default function HomeForDesigner2() {
  return (
    <StyledRoot>
      <StyledWrap>
        <Container component={MotionViewport} sx={{ position: 'relative' }}>
          <Grid container>
            ...
            <Grid item md={6}>
              <StyledContent src="https://thumbs.dreamstime.com/b/caracter-masculino-del-trabajador-de-oficina-sentado-en-la-mesa-con-programador-computadora-escribe-c%C3%B3digo-programa-empresario-223362294.jpg" variants={varFade().in} />
            </Grid>
          </Grid>
        </Container>
      ...
      <m.div variants={varFade().inUp}>
        <Typography
          ...
          sx={{
            ...
            mb: 5,
            ...textGradient(
              `300deg, ${theme.palette.secondary.main} 0%, ${theme.palette.warning.main} 100%`
            ),
          }}
        >
          Experiencia Laboral

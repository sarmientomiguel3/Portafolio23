      ...
      <StyledWrap>
        <Container component={MotionViewport} sx={{ position: 'relative' }}>
          <Grid container>
            ...
            <Grid item md={6}>
              <StyledContent src="https://1.bp.blogspot.com/-9qDcsyKpmKA/Xr7SuV65L3I/AAAAAAAAAi8/WZrnPEOx3RIEyjU7BEGkE_wWVG76GzyrQCK4BGAsYHg/w640-h336/LOGOTIPO%2BCOLOR%2BEN%2BFONDO%2BNEGRO.jpg" variants={varFade().in} />
            </Grid>
          </Grid>
        </Container>
